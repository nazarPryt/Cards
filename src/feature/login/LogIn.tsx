         ...
         <div className={s.container}>
            <div className={s.innerWrap}>
               <div className={s.left}>
                  <div
                     className={`${s.buttonTab} ${accordion === 'login' ? s.buttonActive : ''}`}
                  ...
                  <div
                     className={`${s.buttonTab} ${accordion === 'register' ? s.buttonActive : ''}`}
               ...
               <div className={s.right}>
                  {accordion === 'login' && (
                     <form className={s.formWrap}>
                        ...
                        <button onClick={() => setAccordion('forgotPass')}>Forgot Password?</button>
                     </form>
                  )}
                  {accordion === 'register' && (
                     <form className={s.formWrap}>
                        <h3>Register Here</h3>
                        <SuperInputText type={'text'} placeholder="&#xf2bd;   Username" />
                        <SuperInputText type={'password'} placeholder="&#xf084;   Password" />
                        <SuperInputText
                           type={'password'}
